...
def load_model():
    i_path = "/Users/ivan/Desktop/ALL/Model/weight/"
...
if __name__ == '__main__':
    m_path = "/Users/ivan/Desktop/ALL/Code/PyProduct/GitProj/gproj/code/SecurityAI_Round2/"
    ...
    for ind, (img, label_true, label_target, filenames) in enumerate(loader):
        ...
        adv = attacker.attack(model, img, label_true, label_target)
        # CAHNGE BY IVAN
